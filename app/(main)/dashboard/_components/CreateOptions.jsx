...
const CreateOptions = () => {
    return (
        <div className='grid grid-cols-2 gap-7'>
            <Link href="/dashboard/create-interview" className='bg-white border border-gray-200 shadow-md rounded-lg p-6 flex items-center justify-center gap-3 cursor-pointer'
            >
